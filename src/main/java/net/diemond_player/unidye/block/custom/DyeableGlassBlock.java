...
public class DyeableGlassBlock extends GlassBlock implements IDyeableBlock, BeaconBeamBlock {
    ...
    public ItemStack getCloneItemStack(BlockState state, HitResult target, BlockGetter level, BlockPos pos, Player player) {
        if (DyeableLeatheryBlockEntity.getColor(level, pos) != DyeableBlockEntity.DEFAULT_COLOR) {
